...
<html>
	...
	<body style="background: none; !important">
		...
		<audio id="audio" preload="auto" tabindex="0" controls="" style="position: fixed; top: -5000px; left: -5000px;">
			<source src="<?php echo $ytsongurl ?>">
		</audio>
			<ul id="playlist" style="position: fixed; top: -5000px; left: -5000px;">
				<li class="active">
					<a href="<?php echo $ytsongurl1 ?>">
					   1
					</a>
				</li>
				<li>
					<a href="<?php echo $ytsongurl2 ?>">
						2
					</a>
				</li>
				<li>
					<a href="<?php echo $ytsongurl3 ?>">
						3
					</a>
				</li>
			</ul>
		...
		$(function() {
			...
			function init(){
				...
				len = tracks.length; 
				audio[0].volume = <?php echo $volume / 100 ?>;
				audio[0].play();
