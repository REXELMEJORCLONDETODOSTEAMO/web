	...
	<head>
		...
		<?php 
			...
			include('config.php');
				...
				$apikey = $arrapi -> apikey -> mainapikey;
		...
		<div class="admin centre">
			<div class="left" style="display: inline-block; width: 40%; padding-right: 35px; margin-right: 50px; border-right: 1px solid #888;">
				...
				<form method="GET" action="adminutil.php">
					...
					<h2>Music Options</h2>
					<p>You can put music inside the music file. Read the READ ME file for more assistance.</p>
					<p>You can only use OGG Files</p>
					<hr />
						
					<form method="GET" action="adminutil.php">
					
						<h3 style="color: #DDD; margin: 0; padding: 0; margin-top: 10px;">Music 1</h3>
						<input type="text" name="youtubesong" value="<?php echo $ytsongurl; ?>" placeholder="Youtube ID Here">
						
						<h3 style="color: #DDD; margin: 0; padding: 0; margin-top: 10px;">Music 2</h3>
						<input type="text" name="youtubesong2" value="<?php echo $ytsongurl2; ?>" placeholder="Youtube ID 2 Here">
						
						<h3 style="color: #DDD; margin: 0; padding: 0; margin-top: 10px;">Music 3</h3>
